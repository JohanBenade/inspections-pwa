...
DEFECTS = [
    # KITCHEN
    ('5fe88982', 'Counter seating leg support not quite stable', 'NTS'),
    ('16e941da', 'Damp wall by W1 above towel rail', 'NTS'),
    ('ddd7b868', 'Hinges on left lockable pack are loose', 'NTS'),
    ('6957702f', 'Missed grout dove grey fill lines by unit main door', 'NTS'),
    # LOUNGE
    ('3cb1b144', 'Chipped tiles', 'NTS'),
    ('feafbe9d', 'Missing grout in between tiles', 'NTS'),
    # BATHROOM
    ('f27ee884', 'Door makes loud clipping noise by hinges every time it closes', 'NTS'),
    ('b6b5d166', 'Door finish has dents on its exterior surface', 'NTS'),
    ('b3cb1299', 'Mixer cover plate is loose', 'NTS'),
    ('1beaecc9', 'Rose cover plate is loose', 'NTS'),
    # BEDROOM A
    ('04796e27', 'Stains on exterior surface, paint stains on interior surface', 'NTS'),
    ('afcc1bc2', 'Screw-like rubbers on door frame damage the door paint', 'NTS'),
    ('db6da547', 'Gap between frame and gasket', 'NTS'),
    ('14eb7511', 'Tile skirting not flushed well to B.I.C. underside', 'NTS'),
    ('557d6486', 'B.I.C. door stopper not installed', 'NI'),
    # BEDROOM B
    ('340d94a3', 'Screw-like rubbers on door frame damage the door paint', 'NTS'),
    ('31774738', 'Door makes loud clipping noise by hinges every time it closes', 'NTS'),
    ('aef89fec', 'Door hits door stopper plate, not the rubber', 'NTS'),
    ('1136f030', 'Tile skirting not flushed to B.I.C. underside', 'NTS'),
    ('a7f0db32', 'B.I.C. door stopper not installed', 'NI'),
    # BEDROOM C
    ('9fdcd89e', 'Screw-like rubbers on door frame damage the door paint', 'NTS'),
    ('968ba64b', 'Paint stain inside B.I.C.', 'NTS'),
    # BEDROOM D
    ('66cc0d36', 'Screw-like rubbers on door frame damage the door paint', 'NTS'),
    ('c0183fae', 'Door flushes directly with the floor and does not reach door stop', 'NTS'),
    ('a39a8899', 'Tile skirting not flushed to B.I.C. underside', 'NTS'),
]
