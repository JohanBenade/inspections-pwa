"""Import Unit 137 - Block 5 1st Floor
Inspector: Lindokuhle Zulu (insp-005) | Date: 12.02.2026
Defects: 56 (all NTS)
Dropped: 4 kitchen front door + 3 WC shut-off valves + general notes
"""
import sqlite3, uuid
...
DEFECTS = [
    # KITCHEN (11)
    ('99a8d423', 'Plaster work is not consistent as indicated', 'NTS'),
    ('16e941da', 'Paint is chipped as indicated', 'NTS'),
    ('485aba2b', 'Gap between tile trim and tile', 'NTS'),
    ('485aba2b', 'Chipped tile as indicated', 'NTS'),
    ('522b4aeb', 'Chipped tiles as indicated', 'NTS'),
    ('3cf49a3d', 'Gaps between tile skirting and joineries', 'NTS'),
    ('71550213', 'Scratch in paint orchid bay', 'NTS'),
    ('5158daf4', 'Painting in the carcass is not complete as indicated', 'NTS'),
    ('53b1dbfc', 'Scratch at the top as indicated', 'NTS'),
    ('09e5b0d4', 'Fixing to wall is not to standard', 'NTS'),
    ('9d4b7503', 'Top is rough as indicated', 'NTS'),
    # LOUNGE (3)
    ('c248c406', 'Paint orchid bay is not consistent as indicated', 'NTS'),
    ('3cb1b144', 'Chipped tile as indicated', 'NTS'),
    ('a46f716d', 'Gaps between tile skirting and the floor', 'NTS'),
    # BEDROOM A (9)
    ('afcc1bc2', 'Scratch in the finish as indicated', 'NTS'),
    ('2b8649e7', 'Scratch on the paint on outside as indicated', 'NTS'),
    ('a1eecb62', 'Scratch in paint orchid bay as indicated', 'NTS'),
    ('a1eecb62', 'Paint orchid bay needs to be cleaned', 'NTS'),
    ('41c9bd11', 'Chipped tile as indicated', 'NTS'),
    ('e1d9e932', 'Grout needs to be cleaned', 'NTS'),
    ('14eb7511', 'Gap between tile skirting and B.I.C', 'NTS'),
    ('4033e53f', 'Study desk light bulb screw is not all the way in', 'NTS'),
    ('1ca36641', 'Screw missing to the wall', 'NTS'),
    # BEDROOM B (9)
    ('340d94a3', 'Scratch in the finish as indicated', 'NTS'),
    ('8b80d8a5', 'Overlapping paint', 'NTS'),
    ('59a35f5a', 'Glass needs to be cleaned', 'NTS'),
    ('0ff76a3f', 'Gasket is not to standard', 'NTS'),
    ('1136f030', 'Gap between tile skirting and B.I.C', 'NTS'),
    ('e3778360', 'Obstacle inside the ceiling mounted light', 'NTS'),
    ('de73d950', 'Paint marks on the double light switch', 'NTS'),
    ('2de13909', 'Rust in the carcass', 'NTS'),
    ('5d1dc2bd', 'Loose screw as indicated', 'NTS'),
    # BEDROOM C (7)
    ('6bc58353', 'Scratch on the paint on the outside', 'NTS'),
    ('9fdcd89e', 'Overlapping paint on the finish as indicated', 'NTS'),
    ('5628303a', 'Spots in the paint orchid bay as indicated', 'NTS'),
    ('1fae2eac', 'Paint marks on the frame', 'NTS'),
    ('6a0771ae', 'Gap between tile skirting and B.I.C', 'NTS'),
    ('6579fac6', 'Overlapping paint mark on the ceiling', 'NTS'),
    ('981e4097', 'Paint is missing in the carcass as indicated', 'NTS'),
    # BEDROOM D (9)
    ('3b18b7d5', 'Paint on outside is chipped as indicated', 'NTS'),
    ('248d3871', 'Scratch in the paint orchid bay as indicated', 'NTS'),
    ('bd6a61c0', 'Scratch in the paint yellow balloon as indicated', 'NTS'),
    ('4a354d81', 'Frame needs to be cleaned', 'NTS'),
    ('54ac6a45', 'Chipped tile as indicated', 'NTS'),
    ('956b6837', 'Gap in grout as indicated', 'NTS'),
    ('a39a8899', 'Gap between tile skirting and B.I.C', 'NTS'),
    ('263b99ba', 'Carcass has overlapping paint as indicated', 'NTS'),
    ('07ad730b', 'Paint marks in the finish', 'NTS'),
    # BATHROOM (8)
    ('b6b5d166', 'Finish is not applied at the top of the door', 'NTS'),
    ('e326b993', 'Scratch in the finish as indicated', 'NTS'),
    ('c16fbe1e', 'WC indicator and thumb turn is not working', 'NTS'),
    ('25dda2a3', 'Scratch in the frame as indicated', 'NTS'),
    ('f1438790', 'Gap in grout as indicated', 'NTS'),
    ('07d644a5', 'Frame needs to be cleaned', 'NTS'),
    ('07d644a5', 'Tape needs to be removed', 'NTS'),
