...
defects = [
    # KITCHEN
    ('8ab50f6a', 'not_to_standard', 'W1a makes a squeak when being opened'),
    ('2b85b587', 'not_to_standard', 'Cracks inside the pack'),
    ('3738af64', 'not_to_standard', 'Locks installed upside down (one lock facing up and the other facing down when opening)'),
    ('218f3d5a', 'not_to_standard', 'Locks installed upside down (one lock facing up and the other facing down when opening)'),
    ('445ab368', 'not_to_standard', 'Sand in runner'),
    # BATHROOM
    ('1658968a', 'not_to_standard', 'Door does not touch the rubber on door stop'),
    ('019d6605', 'not_to_standard', 'Arm plate is loose'),
    # BEDROOM A
    ('5be0243e', 'not_to_standard', 'Gaskets have gaps with window frame'),
    # BEDROOM B
    ('6348ca23', 'not_to_standard', 'Window makes a squeak when being opened'),
    # BEDROOM C
    ('8ed179fe', 'not_to_standard', 'Sand in hinges'),
    # BEDROOM D
    ('8638d78f', 'not_to_standard', 'Sand in hinge'),
    # LOUNGE
