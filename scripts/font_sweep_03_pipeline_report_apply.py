#!/usr/bin/env python3
"""
Pipeline Report font sweep: drop unused Cormorant Garamond from @import.
...
Run from repo root: python3 scripts/font_sweep_03_pipeline_report_apply.py
"""
from pathlib import Path

TARGET = Path("app/templates/analytics/pipeline_report.html")
...
print("Pipeline Report font sweep applied.")
