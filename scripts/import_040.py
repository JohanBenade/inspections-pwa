...
defects = [
    # KITCHEN
    ('2aefb106', 'not_to_standard', 'Chipped tile at sink splash back'),
    ('065b6eb7', 'not_to_standard', 'Gap on the bottom left corner of the window'),
    ...
    # KITCHEN - DROPPED (front door excluded)
    ('c897b472', 'not_to_standard', 'Door leaf and frame are skew (gap at the bottom of the door)'),
    ('244e8c43', 'not_to_standard', 'Door has no thumb turn'),
    # BATHROOM
    ('4abe1624', 'not_to_standard', 'Airbrick finish is dirty'),
    ('347c7f63', 'not_to_standard', 'Tiles on the reveal have no grout'),
    ('7cd10dda', 'not_to_standard', 'Shower airbrick is loose'),
    ('f8fb4aed', 'not_to_standard', 'Window sill is dirty'),
    ...
    ('557d6486', 'not_to_standard', 'B.I.C. right leaf has no hinge at the bottom'),
    ('03e99050', 'not_to_standard', 'Study desk missing 1 screw to wall'),
    # BEDROOM B
    ('5d1dc2bd', 'not_to_standard', 'Study desk missing 1 screw to wall'),
    # BEDROOM C
    ('9fdcd89e', 'not_to_standard', 'Door frame has chipped paint'),
    ...
    # BEDROOM D
    ('66cc0d36', 'not_to_standard', 'Door frame has chipped paint'),
    ('54ac6a45', 'not_to_standard', 'Hollow and broken tile under the study desk'),
