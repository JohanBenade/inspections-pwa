...
defects = [
    # KITCHEN
    ('5fe88982', 'not_to_standard', 'Counter seating loose to floor'),
    ('ddd7b868', 'not_to_standard', 'Stove wiring inside to be secured well'),
    ('38b69f7c', 'not_to_standard', 'Edge on left damaged as indicated'),
    ('7f7ddc15', 'not_to_standard', 'Damaged on top edge as indicated'),
    # BATHROOM
    ('b6b5d166', 'not_to_standard', 'Black stain on door exterior'),
    ('ef937d8f', 'not_to_standard', 'Hollow tile behind door as indicated'),
    ('019d6605', 'not_to_standard', 'Arm cover plate is loose'),
    ('1beaecc9', 'not_to_standard', 'Rose cover plate loose'),
    ('b9805e6c', 'not_to_standard', 'WC shut off valve to be tested, does not refill toilet bucket'),
    # BEDROOM A
    ('afcc1bc2', 'not_to_standard', 'Frame stained with yellowish/lighter green shade coloured paint'),
    # BEDROOM B
    ('2de13909', 'not_to_standard', 'Divider cracked'),
    # BEDROOM C
    ('80177e8e', 'not_to_standard', 'Uneven paint above door, patches of paint and not full finish'),
    # BEDROOM D
    ('212d83e1', 'not_to_standard', 'Uneven paint above door, patches of paint and not full finish'),
    # LOUNGE
...
conn.close()
print()
print(f'DONE - Unit {UNIT_NUMBER} imported successfully')
