...
defects = [
    # KITCHEN (3)
    ('197ab3b2', 'not_to_standard', 'Shelf not installed/fitted in properly'),
    ('6e557218', 'not_to_standard', 'Stove wiring inside to be secured well'),
    ('7f7ddc15', 'not_to_standard', 'Damaged edge as indicated'),
    # BATHROOM (4)
    ('b6b5d166', 'not_to_standard', 'Top part not painted as indicated'),
    ('ef937d8f', 'not_to_standard', 'Hollow tile behind door'),
    ('019d6605', 'not_to_standard', 'Arm cover plate is loose'),
    ('1beaecc9', 'not_to_standard', 'Rose cover plate is loose'),
    # BEDROOM A (4)
    ('2b8649e7', 'not_to_standard', 'Scratches on door exterior'),
    ('04796e27', 'not_to_standard', 'White paint stains as indicated'),
    ...
    ('2de13909', 'not_to_standard', 'Random screw hole inside 2nd cabinet as indicated'),
    # BEDROOM C (4)
    ('6bc58353', 'not_to_standard', 'White paint stains on door exterior as indicated'),
    ('80177e8e', 'not_to_standard', 'Scratches on door exterior'),
    ('6624b692', 'not_to_standard', 'Cracked plaster by panel heater'),
    ('968ba64b', 'not_to_standard', 'Clothing hanger inside B.I.C is not installed'),
    # BEDROOM D (3)
    ('45dd2301', 'not_to_standard', 'White paint stains on door exterior as indicated'),
    ('248d3871', 'not_to_standard', 'Uneven paint application by window 3'),
...
conn.close()
print()
print('DONE - Unit 032 imported successfully')
