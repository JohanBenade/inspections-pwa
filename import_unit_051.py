...
DEFECTS = [
    # KITCHEN
    ('739d11f9', 'Handle plate has a loose screw', 'NTS'),
    ...
    ('522b4aeb', 'Chipped tile next to the counter seating', 'NTS'),
    ('5158daf4', 'Wet wall inside sink pack', 'NTS'),
    ('445ab368', 'Bin drawer hard to push and pull', 'NTS'),
    ...
    # BATHROOM
    ('b6b5d166', 'Scratches on door caused by rubber stud on frame hitting door', 'NTS'),
    ('ebb584a4', 'Plastic packaging is still on handle', 'NTS'),
    ('0514ada9', 'Glass needs to be cleaned', 'NTS'),
    ('07d644a5', 'Sand in hinges', 'NTS'),
    ('e2528889', 'Gasket leaves gaps with window frame', 'NTS'),
    ('818a1716', 'Smudges paint on floor tile', 'NTS'),
    ...
    # BEDROOM A
    ('04796e27', 'Door paint needs to be reapplied where indicated', 'NTS'),
    ...
    ('f42cffed', 'Screws below the study desk are loose', 'NTS'),
    # BEDROOM D
