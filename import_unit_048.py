...
DEFECTS = [
    ('0a89cbd6', 'Door does not touch door stop, touches the floor instead', 'NTS'),
    ('cbaefabd', 'Glass needs to be cleaned', 'NTS'),
    ('065b6eb7', 'Sand in hinges', 'NTS'),
    ('707304a2', 'Glass needs to be cleaned', 'NTS'),
    ('065b6eb7', 'Sand in hinges', 'NTS'),
    ('1161cc67', 'Ceiling-mounted light has only one bulb', 'NTS'),
    ('445ab368', 'Bin drawer runners get stuck when opening', 'NTS'),
    ('3738af64', 'Locks installed upside down (one lock facing up and the other facing down)', 'NTS'),
    ('218f3d5a', 'Locks installed upside down (one lock facing up and the other facing down)', 'NTS'),
    ('7f7ddc15', 'Dirt inside cupboard', 'NTS'),
    ('a46f716d', 'Gaps between tile skirting and floor, no grout installed', 'NTS'),
    ('c16fbe1e', 'Door cannot fully turn, therefore cannot lock the door', 'NTS'),
    ('f1438790', 'Gaps between tiles at right corner of shower, no grout installed', 'NTS'),
    ('0514ada9', 'Glass needs to be cleaned', 'NTS'),
    ('e2528889', 'Gasket leaves gaps with window frame', 'NTS'),
    ('107b77d6', 'Ceiling-mounted light has only one bulb', 'NTS'),
    ('b3cb1299', 'Arm plate is loose', 'NTS'),
    ('1beaecc9', 'Rose and its plate are loose', 'NTS'),
    ('04796e27', 'Scratches on door caused by rubber stud on frame hitting door', 'NTS'),
    ('afcc1bc2', 'Scratches on door frame', 'NTS'),
    ('557d6486', 'No door stopper at B.I.C. door', 'NI'),
    ('03e99050', 'White paint on study desk', 'NTS'),
    ('59a35f5a', 'Glass needs to be cleaned', 'NTS'),
    ('09b9fc9b', 'Sand in hinges', 'NTS'),
    ('a7f0db32', 'No door stopper at B.I.C. door', 'NI'),
    ('80177e8e', 'Scratches on door caused by rubber stud on frame hitting door', 'NTS'),
    ('1fae2eac', 'Sand in hinges', 'NTS'),
    ('3f2f2146', 'Glass needs to be cleaned', 'NTS'),
    ('f42cffed', 'Study desk has a missing screw', 'NTS'),
    ('212d83e1', 'Scratches on door caused by rubber stud on frame hitting door', 'NTS'),
    ('05c84b01', 'Chipped wall above door', 'NTS'),
    ('4a354d81', 'Sand in hinges', 'NTS'),
