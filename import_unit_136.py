"""Import Unit 136 - Block 5 1st Floor
Inspector: Thembinkosi Biko (insp-004) | Date: 12.02.2026
Defects: 18 (all NTS)
Dropped: 2 kitchen front door (excluded) + 5 towel rails (FF&E) + general notes
"""
import sqlite3, uuid
...
DEFECTS = [
    # KITCHEN (2)
    ('4ff599bf', 'Hinges need to be tightened', 'NTS'),
    ('ddd7b868', 'Need to secure stove wiring', 'NTS'),
    # LOUNGE (1)
    ('3cb1b144', 'Hollow tile', 'NTS'),
    # BATHROOM (5)
    ('b6b5d166', 'Door upside not finished', 'NTS'),
    ('ef937d8f', 'Hollow tile', 'NTS'),
    ('818a1716', 'Hollow tile', 'NTS'),
    ('b3cb1299', 'SHR Mixer plate is loose', 'NTS'),
    ('1beaecc9', 'SHR Rose plate is loose', 'NTS'),
    # BEDROOM A (4)
    ('04796e27', 'Stains on door interior', 'NTS'),
    ('04796e27', 'Paint peeling off under lockset plate', 'NTS'),
    ('eae7e6e1', 'Door is bent/out of shape', 'NTS'),
    ('59a4040c', 'Paint peeling off by floating shelf', 'NTS'),
    # BEDROOM B (1)
    ('d1bfc830', 'Wall chipped around B.I.C door stopper', 'NTS'),
    # BEDROOM C (3)
    ('80177e8e', 'Upside not finished', 'NTS'),
    ('e833bf33', 'Door makes loud clipping sound by hinges when opening', 'NTS'),
    ('9fdcd89e', 'Striker plate off place because door lockset does not click into place when closed', 'NTS'),
    # BEDROOM D (2)
    ('c0183fae', 'Door is making a loud clipping sound when closing', 'NTS'),
