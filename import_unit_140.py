"""Import Unit 140 - Block 5 1st Floor
Inspector: Thando Sibanyoni (insp-007) | Date: 12.02.2026
Defects: 33 (all NTS)
Dropped: front door + 2 bedroom locksets + towel rail + robe hook + sink mixer + general
"""
import sqlite3, uuid
...
DEFECTS = [
    ...
    ('0b7ae206', 'Lower window does not close', 'NTS'),
    ('ddd7b868', 'Stove wiring not secured', 'NTS'),
    ('255488c3', 'Hinges are loose as indicated', 'NTS'),
    ('445ab368', 'Operational but obstructed by faulty runners', 'NTS'),
    ('0ae68663', 'Hinges are loose as indicated', 'NTS'),
    ('09e5b0d4', 'Island top fixed with shims', 'NTS'),
    ('218f3d5a', 'Does not lock', 'NTS'),
    ('e96314c5', 'Finish scratched near handle', 'NTS'),
    ('4ff599bf', 'Loose hinge', 'NTS'),
    # LOUNGE (1)
    ('c248c406', 'Paint marks as indicated', 'NTS'),
    # BEDROOM A (3)
    ('afcc1bc2', 'Paint is damaged as indicated', 'NTS'),
    ('59a4040c', 'Paint damage and water marks as indicated', 'NTS'),
    ('dc0e02ee', 'Paint marks as indicated', 'NTS'),
    # BEDROOM B (5)
    ('b1f2960d', 'Paint damaged as indicated', 'NTS'),
    ('340d94a3', 'Paint damaged as indicated', 'NTS'),
    ('2ed16ab7', 'Chipped tile as indicated', 'NTS'),
    ('f2df64a6', 'Paint marks as indicated', 'NTS'),
    ('05790528', 'Finish damaged at the top', 'NTS'),
    # BEDROOM C (3)
    ('80177e8e', 'Paint damaged as indicated', 'NTS'),
    ('53a6348d', 'Paint damaged as indicated', 'NTS'),
    ('f42cffed', 'Missing screws under desk', 'NTS'),
    # BEDROOM D (4)
    ('212d83e1', 'Paint damaged as indicated', 'NTS'),
    ('5b96638f', 'Faulty switch connection, bedroom switch affects bathroom light', 'NTS'),
    ('07ad730b', 'Damaged finish as indicated', 'NTS'),
    ('135828f3', 'Damaged finish as indicated', 'NTS'),
    # BATHROOM (7)
    ('b6b5d166', 'Paint damaged as indicated', 'NTS'),
    ('c16fbe1e', 'Occupancy indicator faulty', 'NTS'),
    ('107b77d6', 'Incorrectly wired to Bedroom D switch', 'NTS'),
    ('b3cb1299', 'Mixer has no sealant against wall', 'NTS'),
    ('0a8a0ca3', 'Trap flooded - not operational', 'NTS'),
    ('e5372c9d', 'Hot shut off valve has no sealant against wall', 'NTS'),
    ('a9e99c5e', 'Cold shut off valve has no sealant against wall', 'NTS'),
]
